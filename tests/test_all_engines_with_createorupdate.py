#!/usr/bin/env python3
"""
Test all engine types using createOrUpdateCalculation (which we know works)
"""
...
print("="*70)
print(" TEST: All Engine Types with createOrUpdateCalculation")
print("="*70)
...
# Create calculation with ALL THREE engine types at once
print(f"\n[2] Creating calculation with mathjs, multiline_mathjs, and python...")

stmt_ids = [generate_nanoid() for _ in range(3)]
