...
```python
# Assuming beam_length and load are defined in mathjs statements
moment = beam_length * load
...
## Verified Working Page

**Complete multi-statement calculation with cross-references:**
https://app.calctree.com/edit/98ea9cce-909a-44e9-9359-be53c3d67d04/DMiiWjtSp4Sq_TLU-GgHt

This page demonstrates:
- Multiple mathjs statements
- Variable cross-referencing
- Proper syntax: `variable_name = value units`
- Calculated variables referencing other variables
